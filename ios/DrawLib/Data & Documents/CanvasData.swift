...
open class CanvasData {
    ...
    open func append(lines: [MLLine], with brush: Brush, drewIn: CGRect) {
        ...
        if let lineStrip = currentElement as? LineStrip, lineStrip.brush === brush {
            ...
            let lineStrip = LineStrip(lines: lines, brush: brush, drewIn: drewIn)
    ...
    public func transformData(renderIn: CGRect){
        elements.forEach { (element) in
            let line = element as! LineStrip
            line.transformData(renderIn: renderIn)
...
//    }
    ...
    private(set) var undoArray: [LineStrip] = []
